...
### params ### 
E1 = [0,1,2] # list of energy eigenvalues of input Hamiltonian
...
Gp   =  True # Gibbs-preserving constraint
...
### save data ###
np.savetxt('beta'+ str(beta) +'_E1_' + str(E1) + '_E2_' + str(E2) +'.out', (xvals,zvals,g2_0*np.ones(len(xvals))))
...
ax1.fill_betweenx(np.array(zvals), -np.array(xvals), np.array(xvals),facecolor='lightsteelblue', alpha=0.5)
...
fig.savefig('beta'+ str(beta) +'_E1_' + str(E1) + '_E2_' + str(E2) +".png", dpi=800)
